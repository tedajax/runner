...
static inline void bullet_source_on(BulletSource* self) { self->active = true; self->fireTimer = 0.f; }
static inline void bullet_source_off(BulletSource* self) { self->active = false; self->fireTimer = 0.f; }
